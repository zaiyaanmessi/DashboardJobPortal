                                ...
                                <div className="member-login">
                                    ...
                                    <div className="info-member">
                                        ...
                                        <Menu as="div" className="dropdown">
                                            ...
                                            <Menu.Items as="ul" className="dropdown-menu dropdown-menu-light dropdown-menu-end show" style={{ right: "0", left: "auto" }}>
                                                <li><Link className="dropdown-item" href="/profile">Dashboard</Link></li>
                                                <li><Link className="dropdown-item" href="/my-resume">Profile</Link></li>
                                                <li><Link className="dropdown-item" href="/login">My Resume</Link></li>
                                                <li><Link className="dropdown-item" href="/login">My Applied</Link></li>
                                                <li><Link className="dropdown-item" href="/login">Jobs Shortlist</Link></li>
                                                <li><Link className="dropdown-item" href="/login">Job alerts</Link></li>
                                                <li><Link className="dropdown-item" href="/login">Packages</Link></li>
                                                <li><Link className="dropdown-item" href="/login">Messages</Link></li>
                                                <li><Link className="dropdown-item" href="/login">Meetings</Link></li>
                                                <li><Link className="dropdown-item" href="/login">Change Password</Link></li>
                                                <li><Link className="dropdown-item" href="/login">Delete Profile</Link></li>
                                                <li><Link className="dropdown-item" href="/login">Logout</Link></li>
